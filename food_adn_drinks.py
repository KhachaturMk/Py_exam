...
ChickenSandwich = FoodAndDrinks('Chicken Sandwich', 10, '(Chicken strips with Teriyaki glaze with onion sauce)')
VeganSandwich = FoodAndDrinks('Vegan Sandwich', 11, '(Spicy vegan patty with fresh vegetables with pickles)')
SteakAndCheeseSandwich = FoodAndDrinks('Steak & Cheese Sandwich', 12, '(Steak with american cheese and chipotle sauce)')
